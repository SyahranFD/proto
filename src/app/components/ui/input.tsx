...
const Input = React.forwardRef<HTMLInputElement, InputProps>(
  ({ className,rightIcon, type, ...props }, ref) => {
    return (

        <div className={'px-3 border-2 focus-within:border-primary border-input rounded-lg w-full flex items-center justify-between'}>
            <input
                type={type}
                className={cn(
