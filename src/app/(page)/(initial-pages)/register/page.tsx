...
import FormLayoutLogin from "@/app/(page)/(initial-pages)/register/components/form-layout";
import FormLayoutRegister from "@/app/(page)/(initial-pages)/login/components/form-layout";
